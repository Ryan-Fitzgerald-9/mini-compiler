...
class Parser:
    def __init__(self, lexer, emitter):
        ...
        self.labelsGotoed = set()    # Labels goto'ed
    ...
    def statement(self):
        ...
        if self.checkToken(TokenType.PRINT):
            ...
            if self.checkToken(TokenType.STRING):
                # Simple string and print
                self.emitter.emitLine("printf(\"" + self.curToken.text + "\\n\");")
                self.nextToken()
            else:
                # Expect expression and print
        ...
        # "INPUT" ident
            ...
            # Emit scanf but also validate the input. If invalid, variable set to 0 and input cleared
